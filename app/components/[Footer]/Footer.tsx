...
const Footer = () => {
  return (
    <footer className="bg-gray-200 text-black p-8 py-8">
        ...
        <div>
          ...
          <div className="mb-4">
            <p className="md:w-120">
              ...
              Belleville, Buttes-Chaumont, Place des Fêtes des XIXème et XXème
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-body max-sm:text-center">
          © 2026 - Vues d&apos;ici - Tous droits réservés.
        </span>
